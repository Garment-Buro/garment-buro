# Plus2Opacity: данные сайта для интеграции CRM

Документ описывает, какие данные сейчас хранит сайт Plus2Opacity/Garment Buro, где они лежат и в каком формате их лучше читать или передавать в CRM.
