...
export default function OrderSuccessPage() {
    return (
        <Container size="1200" className="flex flex-col items-center justify-center min-h-[60vh] text-center pt-[130px] mb-[100px]">
            <Text size={20} className="mb-4 text-black">Заказ №001 успешно оформлен</Text>

            <div className="flex flex-col gap-1 mb-10 text-[11px] text-black">
                <p>Информация о заказе выслана на Вашу электронную почту.</p>
                <p>Статусы заказа будут отслеживаться и сообщаться на Вашу электронную почту.</p>
            </div>

            <div className="mb-10 text-[#666666]">
                <svg width="40" height="30" viewBox="0 0 40 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 15L15 28L38 2" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            </div>
            ...
            <NextLink href="/">
                <Button variant="secondary" className="w-[300px] h-[45px] bg-[linear-gradient(180deg,#FFFFFF_0%,#F2F2F2_100%)] border border-black/5 hover:opacity-80 rounded-[8px] shadow-sm">
                    <Text size={16} className="text-black">на главную</Text>
                </Button>
            </NextLink>
        </Container>
    );
